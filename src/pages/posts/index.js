...
import tmm from "../../assets/posts/others/touch_my_melody.jpg"
import Lingerie from "./others/LingerieTMM";

import family1 from "../../assets/posts/family/0787.jpg"
import FamilyPortraits from "./family/FamilyPortraits";

import lovezone1 from "../../assets/posts/sports/lovezone1.jpg"
import LovezoneEvent from "./sports/LovezoneEvent";

import vendor1 from "../../assets/posts/couples/vendor1.jpg"
import LuxuryPicnics from "./couples/LuxuryPicnics";

import lovezone2 from "../../assets/posts/sports/lovezone2.jpg"
import LovezoneJam from "./sports/LovezoneJam";

import winterPark1 from  "../../assets/posts/sports/winterPark1.jpg"
import WinterParkNov from "./sports/WinterParkNov";

import elopementWinter1 from "../../assets/posts/couples/elopmentWinter1.jpg"
import ElopingSnowOutfit from "./sports/ElopingSnowOutfit";

import zoom1 from "../../assets/posts/personal-branding/zoom.jpg"
import BackdropsMeetings from "./personal-branding/BackdropsMeetings";

import proposal2 from "../../assets/posts/couples/proposalRockyMountain.png"
import RockyMoutainEngag from "./couples/RockyMountainEngag";

import proposal3 from "../../assets/posts/couples/proposalLilyLake.jpg"
import ProposalNoHike from "./couples/ProposalNoHike";

import proposal4 from "../../assets/posts/couples/proposalSanSophia.jpg"
import ProposalSanSophia from "./couples/ProposalSanSophia";

import rings from "../../assets/posts/couples/rings.jpg"
import EngagementRings from "./couples/EngagementRings";

import proposal5 from "../../assets/posts/couples/proposalFortCollins.jpg"
import ProposalFortCollins from "./couples/ProposalFortCollins";

import blackTie from "../../assets/posts/couples/blackTie.jpg"
import BlackTieSession from "./couples/BlackTieSession";

import proposal6 from "../../assets/posts/couples/proposalBotanicGardens.jpg"
import ProposalBotanicGardens from "./couples/ProposalBotanicGardens";

import family2 from "../../assets/posts/family/maroonBells.jpg"
import MaroonBells from "./family/MaroonBells";

import k from "../../assets/posts/personal-branding/Kheadshot.jpg"
import Kheadshot from "./personal-branding/Kheadshot";

import j from "../../assets/posts/sports/j.jpg"
import JsnowboardingExperience from "./sports/JsnowvoardingExperience";

import profile1 from "../../assets/posts/personal-branding/profile1.jpg"
import PreparingForHeadshot from "./personal-branding/PreparingForHeadshot";

import family3 from "../../assets/posts/family/FamilyPortraits1.jpg"
import PortraitsWKidsAndPartners from "./family/PortraitsWKidsAndPartners";

import eandb from "../../assets/posts/couples/EandB.png"
import EandBEngagement from "./couples/EandBEngagement";

import janda from "../../assets/posts/couples/JandA.png"
import JandAEngagement from "./couples/JandAEngagement";

import railerJam from "../../assets/posts/sports/railerJam.jpg"
import EldoraJam from "./sports/EldoraJam";

import family4 from "../../assets/posts/family/familyReunion.jpg"
import FamilyReunionSapphire from "./family/FamilyReunionSapphire";

import portrait1 from "../../assets/posts/portraits/KBP_1186.jpg"
import CasualPortraitSession from "./portraits/CasualPortraitSession";
...
export const posts = [
...

    {
        ...
        categoryFolder: "couples",
        title: "A Surprise Proposal During a Tour in Rocky Mountain National Park",
        category: "Surprise Engagement Proposal",
        excerpt: "This proposal was one of those moments that reminds me why I love what I do. It all started with a simple plan: a scenic tour through Rocky Mountain National Park with Tour Estes Park, led by Bruce. One of them knew about the tour. That was it. What she didn’t know was that a proposal was coming. I worked closely with Bruce and my client ahead of time to plan everything quietly. Timing, location, where I would be standing, and how to keep it all natural. The goal was simple: make it feel like a normal day exploring RMNP.",
        image:proposal1 ,
        component: Surprise
    },
...

    {
        ...
        categoryFolder: "others",
        title: "Touch My Melody | Lingerie",
        category: "Vendors List",
        excerpt: "One brand I genuinely love and often recommend to my photography clients is Touch My Melody. It’s an inclusive lingerie brand born from Brazilian concepts and shaped in the heart of Seattle. Every detail feels intentional, from the fit to the fabrics, and it shows beautifully on camera. The brand releases just one collection per year, with exclusive designs and materials, which makes each piece feel special, thoughtful, and far from mass-produced.",
        image:tmm ,
        component: Lingerie
    },
    {
        slug: "winter-family-portraits",
        categoryFolder: "family",
        title: "Winter Family Portraits | Keystone | Pass Lake | Colorado",
        category: "Winter Family Portrait",
        excerpt: "The Rocky Mountains are magical in winter, and there’s no better place to capture family memories than Loveland Pass, just a short drive from Keystone, Breckenridge, Dillon, and Frisco. This winter, I photographed a family during a mini session perfect for holiday and Christmas card photos and while it was cold, the beauty of the snow-covered peaks made every moment worth it.",
        image:family1 ,
        component: FamilyPortraits
    },
        {
        slug: "proteus-gathering",
        categoryFolder: "sports",
        title: "Proteus Snowboards Pre-Season Gathering at the Lovezone Colorado",
        category: "Documentary Photography",
        excerpt: "The Lovezone, a DIY snowboard hike park built in the trees at Loveland Pass, Colorado, became a meeting point for riders, builders, friends, and brands who live for snowboarding outside of resorts and lift lines. Proteus Snowboards hosted a pre-season gathering that captured what grassroots snowboarding is truly about: hiking for your turns, building features by hand, and sharing food and music.",
        image:lovezone1 ,
        component: LovezoneEvent
    },
        {
        slug: "moutain-proposal-luxury-picnic",
        categoryFolder: "couples",
        title: "Colorado Mountain Proposal Photography + Styled Picnic",
        category: "Experience | Vendor",
        excerpt: "I’m so excited to introduce the Proposal Picnic Experience, created in partnership with Brightfolk Gatherings — a thoughtfully designed proposal option for couples looking for romantic proposal ideas in Denver, Boulder, and Colorado’s mountain locations. Imagine arriving at a quiet, beautiful spot to find a cozy picnic scene already waiting for you. Luxe linens layered with natural textures. Plush cushions inviting you to slow down. Soft florals adding warmth without overpowering the moment.",
        image:vendor1 ,
        component: LuxuryPicnics
    },

        {
        slug: "lovezone-community-jam",
        categoryFolder: "sports",
        title: "Lovezone Community Jam | December 13th 2025",
        category: "Documentary Photography",
        excerpt: "Lovezone Community Jam at Loveland Pass Park brought the community together. The park became a meeting point for riders, friends, and supporters who showed up ready to give it everything. It was great seeing familiar faces and reconnecting, while also meeting new people who instantly felt part of the same circle. Everyone who showed up put on a show. The persistence, the commitment, the garra—that grit and hunger to keep trying—was impossible to miss. You could feel it in every hike back up and every reset before dropping in again.",
        image:lovezone2 ,
        component: LovezoneJam
    },

        {
        slug: "winter-park",
        categoryFolder: "sports",
        title: "Winter Park | Ski resort | November 25th 2025",
        category: "Documentary Photography",
        excerpt: "Riding with friends, warming up the legs for the season, testing some new gear, and chasing pockets of good light. When I’m out here, I move between being a rider and being a photographer. I’ll stop, look around, and there’s always someone flowing beautifully down the run... relaxed, focused, living fully in that moment. I love capturing that. If you were at Winter Park on 11/9/25, I may have a photo of you. Or your kid. Or your partner. Or that run where you felt so good.",
        image: winterPark1 ,
        component: WinterParkNov
    },

        {
        slug: "eloping-with-snow",
        categoryFolder: "couples",
        title: "Eloping in the Snow: What to Wear for Your Colorado Winter Elopement",
        category: "Winter Ski Photo Session",
        excerpt: "If you’ve ever dreamed of saying “I do” surrounded by snowy peaks with your skis or snowboard waiting at the lift, Colorado is the perfect place for a winter elopement. The mountains, the golden light, and that cozy mix of adventure and romance make it unforgettable.",
        image: elopementWinter1 ,
        ...
        categoryFolder: "couples",
        title: "Surprise Engagement Proposal | Rocky Mountain National Park | Estes Park",
        category: "Engagement Session",
        excerpt: "Sometimes the most memorable proposals happen when adventure meets intention. Recently, I had the honor of capturing a surprise engagement at Emerald Lake in Rocky Mountain National Park, and it was one for the books.",
        image: proposal2,
        component: RockyMoutainEngag
    },
    
        {
        slug: "surprise-engagement-lily-lake",
        categoryFolder: "couples",
        title: "Surprise Engagement Proposal | Lily Lake | Rocky Mountain National Park",
        category: "Engagement Session",
        excerpt: "Rocky Mountain National Park is one of the most beautiful places in Colorado to pop the question, but you don’t have to hike for hours to find a breathtaking spot. Some of the park’s most scenic locations are just a short walk from the parking lot, making them perfect for a relaxed, stress-free proposal.",
        image: proposal3,
        component: ProposalNoHike
    },

        {
        slug: "surprise-engagement-san-sophia",
        categoryFolder: "couples",
        title: "Surprise Engagement Proposal | San Sophia Overlook | Telluride",
        category: "Engagement Session",
        excerpt: "There’s something truly special about proposing in a place that holds meaning. For one of my recent clients, Telluride wasn’t just a stunning backdrop, it was where they first met. When they asked me to capture their surprise engagement, I knew it would be a moment full of emotion, memories, and breathtaking scenery.",
        image: proposal4,
        component: ProposalSanSophia
    },
        ...
        categoryFolder: "couples",
        title: "Find Your Perfect Engagement Ring: A Reflection of Your Story",
        category: "Engagement Rings",
        excerpt: "An engagement ring is more than a symbol. It’s a piece of your story you’ll carry every day. It holds your adventures, your laughter, your quiet moments, and the promise you made to each other. Over the years, I’ve photographed so many unique rings, each one reflecting a different kind of love.",
        image: rings,
        component: EngagementRings
    },

        {
        slug: "surprise-engagement-fort-collins",
        categoryFolder: "couples",
        title: "Sunrise | Surprise Engagement Proposal | Fort Collins",
        category: "Engagement Session",
        excerpt: "There’s something magical about starting a day with a sunrise—soft light, quiet moments, and the sky painting itself in shades of pink, orange, and gold. A sunrise engagement session near Fort Collins is not only unique but also gives you the perfect backdrop for an unforgettable proposal.",
        image: proposal5,
        component: ProposalFortCollins
    },

        {
        slug: "black-tie-engagement-session",
        categoryFolder: "couples",
        title: "A Black Tie Engagement Session in Denver",
        category: "Engagement Session",
        excerpt: "When your wedding is black tie, why not let your engagement session feel just as elevated? The session itself felt like stepping into a Pinterest board. Every corner of Union Station offered architectural elegance, every courthouse step added drama and formality. The sneak peeks are out in black and white, with a beautiful grain that highlights the textures and timelessness of this session.",
        image: blackTie,
        component: BlackTieSession
    },

        {
        slug: "surprise-proposal-botanic-gardens",
        categoryFolder: "couples",
        title: "A Surprise Engagement Proposal at Botanic Gardens Denver",
        category: "Engagement Session",
        excerpt: "A proposal is more than just a question—it’s a story, carefully planned and beautifully executed. When he reached out to me at least two weeks in advance, we had the perfect amount of time to plan something truly special. With travel involved and a love for lily pads on her part, the Denver Botanic Gardens offered the perfect backdrop: a serene pond surrounded by greenery, delicate flowers, and that magical golden light at sunset.",
        image: proposal6,
        component:ProposalBotanicGardens
    },
        ...
        excerpt: "There’s something truly special about photographing returning clients—seeing how their story continues, how life has grown and changed since the last time we met. This time, we headed to the breathtaking Maroon Bells for a family session, surrounded by those iconic peaks, crisp air, and colors that felt like they belonged in a painting.",
        image: family2,
        component:MaroonBells
    },

        {
        slug: "k-signature-headshot",
        categoryFolder: "personal-branding",
        title: "K | Signature Headshot",
        category: "Mini Session",
        excerpt: "Quick, easy, and beautifully lit — that’s the idea behind my Signature Headshot Mini Sessions. In just a short session outdoors, you’ll walk away with professional portraits that feel natural, modern, and true to who you are. Katie found me through LinkedIn after realizing her old headshot didn’t feel like her anymore.",
        image: k,
        component:Kheadshot
    },
        ...
        {
        slug: "j-snowboarding-experience",
        categoryFolder: "sports",
        title: "Snowboarding at Keystone Resort",
        category: "Snow Experience Package",
        excerpt: "Snowboarding Photo Experience Session is made for riders who want more than just iPhone snapshots. Whether you’re 28 or 50, a local or visiting for a ski trip, this session documents your day on the mountain. Your style, your ride, your story. From Keystone to Breckenridge, Winter Park, and beyond, you’ll get professional snowboard photos that feel real, candid, and unforgettable.",
        image: j,
        component:JsnowboardingExperience
    },

        {
        slug: "preparing-for-headhost-session",
        categoryFolder: "personal-branding",
        title: "Preparing for your Signature Headshots",
        category: "Mini Sessions",
        excerpt: "So you’ve booked your Signature Headshot Session (YAY!). I’m here to guide you through every step of the process. Here’s how to show up feeling prepared, relaxed, and ready to let your personality shine. Let's talk about clothing, make-up, showing up, and more.",
        image: profile1,
        component:PreparingForHeadshot
    },

        {
        slug: "family-portraits-with-adults-chindren-and-partners",
        categoryFolder: "family",
        title: "Family Portraits with Adult Children and Their Partners",
        category: "Why Now Is the Perfect Time",
        excerpt: "Family portraits aren't just for when the kids are little. In fact, some of the most meaningful family sessions happen when everyone is grown. Adult children, their significant others, maybe even future spouses — your family is still growing, just in a different way. If you're in Broomfield, Arvada, Thornton, or Westminster and it's been a few years (or more) since your last formal family portrait, this is your sign to plan one.",
        image: family3,
        component:PortraitsWKidsAndPartners
    },

        {
        slug: "e+b-engagement",
        categoryFolder: "couples",
        title: "E + B | Engagement Proposal",
        category: "Keystone Colorado | Arapahoe Basin Ski",
        excerpt: "I already knew working with A was going to be a blast—this wasn’t our first shoot together. She had told me ages ago she dreamed of being proposed to at a ski resort and having that moment captured. So when B popped the question on closing day at Vail during a super intimate moment, we all knew: we had to take it to the next level with a photo session that matched their vibe. We planned a two-location engagement shoot that totally reflects who they are: mountain-loving, fun, and down for anything.",
        image: eandb,
        component:EandBEngagement
    },

        {
        slug: "j+a-engagement",
        categoryFolder: "couples",
        title: "J + A | Surprise Engagement Proposal",
        category: "Sunrise Amphitheater | Flagstaff House | Boulder",
        excerpt: "J had been planning this moment for a while, and I had the honor of being in on the secret. Together, we worked out the timeline, the perfect location, and even made arrangements with the restaurant where he had dinner reservations after the big moment. I called ahead to make sure everything was in place, so we could keep the magic going and capture some portraits there too. The weather had been moody and gray all week — the kind that makes you check the forecast a dozen times a day. But the universe had other plans. Just in time for the proposal, the skies cleared. The golden light broke through, and the view ofBoulder...",
        image: janda,
        component:JandAEngagement
    },

        {
        slug: "eldora-resort-park-girls-rail-jam",
        categoryFolder: "sports",
        title: "Eldora Resort Woodward Railer Park Girls Rail Jam 2025",
        category: "by Snowboarding & Ski Event Photographer | Based in Colorado",
        excerpt: "This spring, I headed up to Eldora Mountain Resort to photograph the Railer Park Girls Rail Jam 2025 — and it did not disappoint. The sun was out, the stoke was high, and both pros and locals showed up to throw down. The event had a laid-back, fun atmosphere — that perfect mix of competition and community. Riders lined up at the top of the rail garden, the crowd cheered from the sides, and the day kicked off with the Girl’s Jam, spotlighting a strong group of women skiers and snowboarders pushing style and creativity.",
        image: railerJam,
        component:EldoraJam
    },

        {
        slug: "family-reunion-at-sapphire-point-overlook",
        categoryFolder: "family",
        title: "Family Reunion at Sapphire Point Overlook – A Winter Session in the Colorado Mountains",
        category: "by Broomfield-Based Family Photographer",
        excerpt: "There’s something incredibly special about documenting a family reunion — especially when it brings generations together in a setting as beautiful as Sapphire Point Overlook, just outside Breckenridge, Colorado. For this winter session, we met up with a close-knit family made up of adult sons, their moms, and a grandson, all gathered to enjoy time in the snow and create some lasting memories. The sky was cloudy but bright, and the snow made the landscape feel peaceful and timeless — a perfect backdrop for a mix of candid and lightly posed portraits.",
        image: family4,
        component:FamilyReunionSapphire
    },

        {
        slug: "casula-colorful-portrait-session",
        categoryFolder: "portraits",
        title: "From Denver to Sapphire Point: A Casual, Colorful Portrait Session in the Colorado Mountains",
        category: "by KB Photographer",
        excerpt: "Late April in Colorado is a little unpredictable — snow in the mountains, sunshine in the city, and everything in between. For this portrait session, we started in Denver, then made our way up into the mountains, stopping at Loveland Pass before heading to our final location: Sapphire Point Overlook near Breckenridge. The drive itself was beautiful. Cloudy skies with bursts of blue breaking through, fresh mountain air, and just enough chill to remind us that winter wasn’t fully gone yet.",
        image: portrait1,
        component:CasualPortraitSession
    },

        {
        slug: "spring-portrait-session-at-lily-lake",
        categoryFolder: "portraits",
        title: "Spring Portrait Session at Lily Lake and RMNP",
        category: "by KB Photographer",
        excerpt: "Spring in Colorado can feel like a mix of seasons — sunny skies, cool wind, and snow still hanging around in the mountains. For this portrait session, we explored two of my favorite places: Lily Lake and Rocky Mountain National Park (RMNP) near Estes Park. We started at Lily Lake, where we walked out onto the dock. The wind was strong, but the sun was out and the lake views were beautiful. She wore a long dress paired with a heavy coat — a perfect mix of style and comfort for the chilly weather. The clear blue sky made a perfect backdrop for natural, candid portraits.",
        image: portrait2,
